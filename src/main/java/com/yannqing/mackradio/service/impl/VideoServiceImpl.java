...
//                nameToWav();
                ...
                picture.forEach(pic -> {
                    htmlToPng(pic, "./image/images/" + imageDir + "/" + UUID.randomUUID() + ".png");
                });
     ...
     * @throws IOException
     */
    public void getMp3Byjava(String text, String name) throws IOException, InterruptedException, UnsupportedAudioFileException {
        StopWatch stopWatch = new StopWatch();
        stopWatch.start();
        AppClient appClient = new AppClient(API_KEY, API_SECRET);
...
//        File file = new File("C:\\Users\\67121\\video\\text\\" + textFileName);
     ...
     */
    @Override
    public String getMp4Byjava(String text, HttpServletRequest request) throws IOException, InterruptedException, IllegalArgumentException, UnsupportedAudioFileException {
        StopWatch totalWatch = new StopWatch();
        totalWatch.start();
        if (text.length() > 3000) {
    ...
    @Override
    public void change(String text, String srtFilePath, String audioPath, String radioPath, String shPath, String outputPath, String imagePath, String taskId, String background, List<String> picture) throws IOException, UnsupportedAudioFileException, InterruptedException {
        StopWatch stopWatch = new StopWatch();
